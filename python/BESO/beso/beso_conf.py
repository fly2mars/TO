...
#path_calculix = "c:/tools/bConverged/CalculiX/bin/ccx"  # path to the CalculiX solver
#path_calculix = "c:/soft/bConverged/CalculiX/bin/ccx"  # path to the CalculiX solver
path_calculix = "d:/soft/bConverged/CalculiX/CalculiX/bin/ccx"  # path to the CalculiX solver
...
iterations_limit = 20  # 0 - automatic estimate, <integer> - the maximum allowable number of iterations
